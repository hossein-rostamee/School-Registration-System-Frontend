...
export default function HumanResourcesPanelHeader( props ) {
    ...
    useEffect( () => {
        setTitle( props.getClasses    ? titles[2] : 
                  props.getStudents   ? titles[1] :
                  props.getVolunteers ? titles[0] : "" )
    }, [ props.getClasses, props.getStudents, props.getVolunteers ] )
